      ...
      <section className="text-center mb-12">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          ...
          <a
            ...
            className="px-6 py-3 border border-[#1d9bf0] text-[#1d9bf0] font-bold rounded-lg hover:bg-[#1d9bf010] transition-all text-sm flex items-center gap-2"
          >
          ...
          <a
            href={process.env.NEXT_PUBLIC_REPO_URL || 'https://github.com/bidaiAI/wawa'}
            target="_blank"
            rel="noopener noreferrer"
            className="px-6 py-3 border border-[#4b5563] text-[#9ca3af] font-bold rounded-lg hover:border-[#9ca3af] hover:text-[#d1d5db] transition-all text-sm flex items-center gap-2"
          >
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
