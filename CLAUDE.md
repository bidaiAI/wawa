...
```
E:\mortal/
  core/          # Immutable zone (constitution, vault, cost_guard, memory, etc.)
  services/      # AI-writable zone (tarot, future services)
  api/server.py  # FastAPI backend for individual AI instance
  twitter/       # Twitter agent (auto-posting, death tweets)
  main.py        # Entry point, wires all callbacks, runs uvicorn
  web/           # Next.js 16 frontend
    app/ai/      # AI-specific pages (chat, store, highlights, etc.)
    app/platform/# Platform pages (create, gallery, dashboard, admin)
  contracts/     # Solidity smart contracts
  mortal_platform/  # Platform operations (WILL BE PRIVATE)
```
